...
export class InputHandler {
  constructor(game) {
    ...
    if (this.game.isMobile) {
      ...
      const resetJoystick = () => {
        this.game.joystickVector = new THREE.Vector2(0, 0);
      ...
      joystickContainer.addEventListener("touchmove", (e) => {
        ...
        this.game.joystickVector = new THREE.Vector2(deltaX / joystickMaxRadius, deltaY / joystickMaxRadius);
      });
      ...
      const addTouchControl = (buttonId, keyVal) => {
        ...
        btn.addEventListener("touchstart", (e) => { 
          e.preventDefault(); 
          this.keys[keyVal] = true; 
        });
        btn.addEventListener("touchend", (e) => { 
          e.preventDefault(); 
          this.keys[keyVal] = false; 
        });
