export class InputHandler {
  constructor(game) {
    ...
    if (this.game.isMobile) {
      ...
      joystickContainer.addEventListener("touchcancel", e => { e.preventDefault(); resetJoystick(); });
